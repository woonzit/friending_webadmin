...
test("every inventoried functional section has detailed English and Hungarian help", async () => {
  ...
  // 236 since T-218b: the Hey/Footprints family panel lives on Configuration,
  // while Footprints keeps a dedicated pointer explaining the separate family
  // revision and operational scope.
  assert.equal(totalSections, 236, "review the functional-section census when the UI changes");
