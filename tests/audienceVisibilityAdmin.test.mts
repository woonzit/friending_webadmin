...
test("all 43 published Core Webadmin fixtures are unchanged, manifest-bound, and decode by case", async () => {
  ...
  // Re-pinned by T-631 to Core main `20806f8`, whose
  // `tests/fixtures/audience_visibility_wire/manifest.json` carries these two
  // values (the set's bodies were generated by the T-632 commit `bd6ef3f`;
  // `source_commit` has since been rebound twice by whole-`src/` changes).
  assert.equal(manifest.source_commit, "f0c74539a5361f70e310e1ef79616434c89d06f3");
  assert.equal(manifest.fixture_set_sha256, "fe54dbd7772a807bc092c26db6b8a18e426912fdf224aa87cced4242519ecdf2");
